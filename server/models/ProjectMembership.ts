// FILE: server/models/ProjectMembership.ts
...
const ProjectMembershipSchema = new Schema(
  {
    ...
    status: { type: String, required: true, enum: ["active", "removed"], default: "active", index: true },
  },
  { timestamps: true }
);
...
export type ProjectMembershipDoc = InferSchemaType<typeof ProjectMembershipSchema> & { _id: mongoose.Types.ObjectId };
