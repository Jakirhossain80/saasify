// FILE: server/models/SavedView.ts
...
export type SavedViewDoc = InferSchemaType<typeof SavedViewSchema> & { _id: mongoose.Types.ObjectId };

export const SavedView: Model<SavedViewDoc> =
  (mongoose.models.SavedView as Model<SavedViewDoc>) || mongoose.model<SavedViewDoc>("SavedView", SavedViewSchema);
